...
const Skills = () => (
  <div id="skills" style={{ bakgroundColor: '#eee' }}>
    ...
    <SkillsContainer>
      ...
      <p>
        I've developed too some desktop tools like geoprocessing tools using
        Python and arcpy. Also, I've done some experiments with Android apps and
        Swift iOS apps. Other skills that I have are Photoshop design, sense of
        humour or practicing sports. Also, I love learning new languages,
        traveling around, hiking or going to coding conferences.
      </p>
    </SkillsContainer>
  </div>
)
