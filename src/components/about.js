    ...
    return (
      <div id="about">
        ...
        <p>
          ...
          several tools for geoprocessing. Since then, I've done many projects,
          some as back-end developer, some as front-end developer and others as
          full-stack developer. In many of my professional projects, I've
          developed complete GIS, web maps or geoprocessing tools. At present,
          I'm attending to{' '}
        ...
        <ColumnContainer>
          <CenterColumn>
            Currently, I'm located in <strong>Santander, Spain</strong>. It's an
            ...
            <button onClick={this.onWhereClick}>where is my city</button> and
